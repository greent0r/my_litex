...
_io = [
    ...
    # uart
    ("uart", 0,
        Subsignal("rx", Pins("J21"),),
        Subsignal("tx", Pins("J25")),
        IOStandard("LVCMOS33"),
    ),

    # gpio
    ("gpioA", 0,  Pins("Y23 Y25 Y22 Y6"), IOStandard("LVCMOS33")),
    ("gpioB", 0,  Pins("L23 C19 K22 D19"), IOStandard("LVCMOS33")),

    # i2c
    ("i2c", 0,
        Subsignal("scl", Pins("J18"), Misc("OPENDRAIN=ON")),
        Subsignal("sda", Pins("J19"),  Misc("OPENDRAIN=ON")),
        IOStandard("LVCMOS33"),
    ),
    ...
    ("spi", 0,
        ...
        Subsignal("mosi", Pins("D24")),
        Subsignal("miso", Pins("C26")),
        IOStandard("LVCMOS33"),
    ),
    ("spi_ctl", 0,
        Subsignal("csn",   Pins("C22")),
        IOStandard("LVCMOS33"),
    ),
